      ...
      <div className={`relative z-10 max-w-4xl text-center space-y-6 transition-all duration-700 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="flex justify-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-medium tracking-tighter text-balance text-foreground">
            AI-Powered Resume Screening & <span className="text-foreground">Candidate Analytics</span>
          </h1>
          
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-balance">
            Upload resumes and get intelligent candidate analysis with skill matching, authenticity scoring, and automated shortlisting. Built for modern HR teams who value efficiency and data-driven hiring.
          </p>
        
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6 items-center">
          <Button className="bg-primary text-primary-foreground hover:bg-primary/80 hover:text-primary-foreground text-base h-12 px-8 transition-all duration-200 min-h-[48px]" onClick={() => window.location.href = '/upload'}>
            Get Started
          </Button>
          <Button variant="outline" className="border-border text-foreground hover:bg-accent hover:text-accent-foreground text-base h-12 px-8 transition-all duration-200 min-h-[48px]" disabled>
            View Pricing
          </Button>
        </div>
        
        <div className="pt-6 text-sm text-muted-foreground">
          No credit card required • Upload up to 100 resumes
        </div>
      </div>
          ...
          <div className="bg-card backdrop-blur-md w-full">
            <div className="flex items-center justify-between p-4 border-b border-border">
              <div className="flex items-center gap-4">
                ...
                <span className="text-foreground font-medium">Resume Analysis Pipeline</span>
              </div>
              ...
              <div className="flex-1 p-4 bg-background overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-6 min-w-0">
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <h3 className="font-medium text-foreground">Candidates</h3>
