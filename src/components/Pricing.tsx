  ...
  const plans = [
    {
      name: "Free",
      price: "Free",
      description: "Perfect for small teams starting with AI resume screening",
      features: [
        "Up to 20 resumes/month",
        "Basic AI parsing",
    ...
    },
    {
      ...
      price: "$49",
      period: "per month",
      description: "Ideal for growing HR teams with higher screening volumes",
      features: [
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-medium tracking-tighter text-foreground">
            Simple pricing for AI resume screening
          </h2>
          <p className="text-muted-foreground text-lg">
            Scale your recruitment process with plans that grow with your hiring needs
          </p>
        </div>
